...
class State():
    ...
    def get_all_rates_rep(self, top_amount=100):
        """служебные функции для получения данных в формате, подходящем для графиков
        этот формат описан в примерах или на офф сайте
        """
        all_tags = {}
...
if (__name__ == "__main__"):
    ...
    короче все эти ваши переменные среды абсолютно не юзабельны на винде и
    боже упаси их использовать. Начиная от полного ахтунга с кавычками.
    Ах, да, cmd инструмент богов. Дьявола если быть точным"""
